...
```
![parameter plot](images/param.trace.plot.png)
![parameter plot](images/param.density.plot.png)
...
```
![topology plot](images/topology.trace.plot.png)
![topology plot](images/topology.density.plot.png)
