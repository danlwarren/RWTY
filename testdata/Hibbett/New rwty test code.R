...
analyze.simple(list(run1, run2), burnin=100, window.num = 50, treespace.points = "x")
analyze.simple(list(run1, run2), burnin=100, window.num = 50, treespace.points = -1)
analyze.simple(list(run1, run2), burnin=100, window.num = 50, treespace.points = 1000)
