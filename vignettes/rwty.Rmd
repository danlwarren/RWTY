...
We have a nice vignette talking about what all of the various plots and diagnostics mean in terms of chain performance, but unfortunately CRAN's filesize limits won't let us include the vignette in the CRAN version.  You can always install from GitHub if you want the vignette stored with the package, or you can find a backup here:
...
```{r analyze.salamanders, results='hide', fig.keep='none', eval=FALSE, message=FALSE, warning=FALSE}
data(salamanders)
...
```{r makeplot.params, results='hide', fig.keep='none', eval=FALSE, message=FALSE, warning=FALSE}
...
```{r param.trace, eval=FALSE, fig.width=8, fig.height=6}
...
```{r param.cor, eval=FALSE, fig.width=8, fig.height=6}
...
```{r param.cor2, eval=FALSE, fig.width=8, fig.height=6}
data(fungus)
...
```{r topo.trace, eval=FALSE, fig.width=8, fig.height=6}
...
```{r autocorr.plot, eval=FALSE, fig.width=8, fig.height=6}
...
```{r treespace.1, eval=FALSE, fig.width=8, fig.height=6}
...
```{r treespace.2, eval=FALSE, fig.width=8, fig.height=6}
...
```{r splitfreq.slide, eval=FALSE, fig.width=8, fig.height=6}
...
For a single chain:
```{r splitfreq.cumulative, eval=FALSE, fig.width=8, fig.height=6}
...
```{r acsf.slide, eval=FALSE, fig.width=8, fig.height=6}
...
```{r asdsf, eval=FALSE, fig.width=8, fig.height=6}
makeplot.asdsf(salamanders[c(1,2)])
```
![asdsf plot](asdsf.plot.png)

### Split frequency scatterplot matrix
These plots are another way of visualizing the agreement or disagreement between the regions of tree space that chains have sampled. For each pair of chains, the cumulative final frequency of each clade (which is also our best estimate of that clade's posterior probability) is plotted against ts frequency in another chain in the lower triangle, and the the correlation (Pearson's R) for each pair of chains is shown in the upper triangle.

```{r splitfreq.matrix, eval=FALSE, fig.width=8, fig.height=6}
...
```{r asdsf.tree, eval=FALSE, fig.width=8, fig.height=6}
